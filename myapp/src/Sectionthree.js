...
function Sectionthree() {
  return (
    <div className="container-fluid text-center" id="gallerytwo">
      <h2 style={{ color: "white", fontWeight: "500", paddingTop: "3rem", paddingBottom: "2rem" }}>
      ...
      <div
        ...
        style={{ marginTop: "2rem", marginBottom: "2rem", paddingBottom: "2rem" }}
      >
        <Button className="btn">FIND MORE ACTIVITIES <i class="arrow right"></i></Button>
